...
if(len(sys.argv)<=1):
    output = os.popen('ls Desktop').read()
    ...
    for file_name in files:
        ...
        if(len(formatted_name) == 1):
            if(formatted_name[len(formatted_name)-1] != "Sorted\ Files\ "+today and "Sorted\ Files\ " not in formatted_name[len(formatted_name)-1] ):
                os.system("mv Desktop/"+formatted_name[len(formatted_name)-1]+" Desktop/Sorted\ Files\ "+today+"/folders")
        else:
            extention =formatted_name[len(formatted_name)-1]
            if(extention == "png" or extention == "jpg" or extention == "jpeg" or extention == "svg"):
                os.system("mv Desktop/"+file_name+" Desktop/Sorted\ Files\ "+today+"/photos/"+file_name)
            elif(extention == "mkv" or extention == "mp4"):
                os.system("mv Desktop/"+file_name+" Desktop/Sorted\ Files\ "+today+"/videos/"+file_name)
            elif(extention == "mp3"):  
                os.system("mv Desktop/"+file_name+" Desktop/Sorted\ Files\ "+today+"/songs/"+file_name)            
            elif(extention == "doc" or extention == "docx" or extention=="pdf"):
                os.system("mv Desktop/"+file_name+" Desktop/Sorted\ Files\ "+today+"/documents/"+file_name)
            elif(extention == "zip" or extention == "rar" or extention == "tar"):
                os.system("mv Desktop/"+file_name+" Desktop/Sorted\ Files\ "+today+"/archives/"+file_name) 
            else:
